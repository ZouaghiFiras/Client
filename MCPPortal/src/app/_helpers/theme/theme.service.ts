...
export class ThemeService implements OnDestroy {
  ...
  isSystemDark(): boolean {
    ...
    return this.document.defaultView?.matchMedia(ThemeService.SYSTEM_DARK_MODE_MEDIA_QUERY).matches!;
  }
...
//
//   /**
//    * Serializes and sets the value of the pair identified by key to value in Local Storage, creating a new key/value pair
...
//
//   /**
//    * Removes the key/value pair with the given key from the list associated with the subObject in Local Storage,
...
//   /**
//    * Constructor.
//    * @param {Document} document Web page loaded in the browser and serves as an entry point into the web page's content,
